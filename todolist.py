...
def deL(no):
    try:
        ...
        print(f"Error: todo #{no} does not exist. Nothing has been deleted.")
...
def nec():
    try:
        ...
        sys.stdout.buffer.write("You have no pending todos! Woohoo!".encode('utf8'))
...
if __name__ == '__main__':
    try:
        ...
        if(args[1] == 'add' and len(args[2:]) == 0):
            ...
            sys.stdout.buffer.write(
                "Error: Missing NUMBER for marking the todo as done.".encode('utf8'))
        elif(args[1] == 'deL' and len(args[2:]) == 0):
            sys.stdout.buffer.write(
                "Error: Missing NUMBER for deleting the todo.".encode('utf8'))
        else:
